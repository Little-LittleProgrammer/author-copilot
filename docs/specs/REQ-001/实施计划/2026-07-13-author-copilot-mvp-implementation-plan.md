...
- RAG 初始基准使用 10 万/100 万/500 万字三档语料和至少 100 条人工标注查询；参考设备上的初始工程线为来源路径/范围正确率 100%、Recall@5 不低于 80%、100 万字检索 p95 小于 300 ms，且单文件增量更新不阻塞正文保存。参考设备或阈值的调整必须留在 ADR 中。
